...
import RightToggleButton from "@/components/ToggleButton/RightToggleButton";
        ...
        <div className="h-full w-full overflow-y-auto pb-[1.667rem]">
          ...
          >
            ...
            <div className="flex-1 flex flex-col gap-[clamp(1.8rem,2vh,1.25rem)] w-full mt-[1rem]">
              ...
              {/* 실시간 경고알림 */}
              <section className="flex flex-col flex-[2_1_0%] basis-[10rem] max-h-[22rem]">
                <h4 className="mb-[0.85rem] text-[1.15rem] font-bold text-gray-700 dark:text-gray-200">실시간 경고알림</h4>
                <div className="flex-1 overflow-auto">
              ...
              {/* 주요 작업정보 */}
              <section className="flex flex-col flex-[1.25_1_0%] basis-[10rem] max_h-[20rem]">
